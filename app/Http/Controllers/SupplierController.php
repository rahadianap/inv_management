...
class SupplierController extends Controller
{
    ...
    {   
        ...
        return to_route('suppliers.index')->with('success', 'Supplier was created');
    }
    ...
    public function update(UpdateSupplierRequest $request, Supplier $supplier)
    {
        ...
        return to_route('suppliers.index')->with('success', 'Supplier was updated');
    }
    ...
    public function getSupplierCode()
    {
        try {
            ...
            if (!$maxCode) { 
                ...
                $count = $maxCode + 1;
                if ($count < 10) { $code = 'SUP-'.'000'.$count; } 
                elseif ($count >= 10 && $count < 100) { $code = 'SUP-'.'00'.$count; } 
                elseif ($count >= 100 && $count < 1000) { $code = 'SUP-'.'0'.$count; } 
                else { $code = 'SUP-'.$count; } 
            }
            return $code;
        } catch(\Exception $e){
